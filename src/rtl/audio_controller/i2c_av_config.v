...
always @(*) begin
    case (lut_index)
        ...
        4'h3: lut_data <= {7'h02, 1'b1, 1'b0, volume}; // left output
        // 4'h4: lut_data <= 16'h0679; // right output
        4'h4: lut_data <= 16'h08d4; // analog path
        4'h5: lut_data <= 16'h0a04; // digital path
        4'h6: lut_data <= 16'h0e01; // digital IF
        4'h7: lut_data <= 16'h1020; // sampling rate
        4'h8: lut_data <= 16'h0c00; // power on everything
        4'h9: lut_data <= 16'h1201; // activate
